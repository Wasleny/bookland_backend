...
get_all_series_usecase = GetAllSeriesUseCase(repository)
get_series_usecase = GetSeriesByIdUseCase(repository)
soft_delete_series_usecase = SoftDeleteSeriesUseCase(repository)
update_series_usecase = UpdateSeriesUseCase(repository)
